...
SELECT e.last_name, d.department_id FROM departments d
FULL JOIN employees e
ON d.department_id = e.department_id

------------------------------------------------------------

SELECT e.department_id, d.department_name FROM departments d
FULL JOIN employees e
ON d.department_id = e.department_id


---Exercise12---
SELECT e.employee_id, e.last_name, e.hire_date, manager.manager_id, manager.last_name, manager.hire_date FROM employees e
